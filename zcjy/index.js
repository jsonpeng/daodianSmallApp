...
function getExtJsons(){
 // console.log(functions.empty(wx.getExtConfigSync()));
  let extConfig = functions.empty(wx.getExtConfigSync()) ? this.extjsonTem() : wx.getExtConfigSync();
  return extConfig;
}
  ...
  var ext_json=
    {
      ...
      "name":"到店系统",
      "theme": { "name": "default", "parent": "default", "display_name": "代购主题", "image": "themes/social/cover.png", "des": "代购主题", "maincolor": "#000", "secondcolor": "#fff" },
      "config": { "FUNC_BRAND":true, "FUNC_PRODUCT_PROMP":true, "FUNC_ORDER_PROMP":true, "FUNC_ORDER_CANCEL":true, "FUNC_AFTERSALE":true, "FUNC_FLASHSALE":true, "FUNC_TEAMSALE":true, "FUNC_COUPON":true, "FUNC_CREDITS":true, " ":true, "FUNC_DISTRIBUTION":true, "FUNC_CASH_WITHDRWA":true, "FUNC_WECHAT":true, "FUNC_MEMBER_LEVEL":true, "FUNC_FAPIAO":true, "FUNC_THEME":true, "FUNC_COLOR":true, "FUNC_FOOTER":true, "FUNC_POST":true, "FUNC_COLLECT":true, "FUNC_YUNLIKE":true, "FUNC_WECHATPAY":true, "FUNC_PAYSAPI":true, "FUNC_ALIPAY":true },
      "tabBar": {
        "color": "#969696",
        "selectedColor": "#e6be78",
        "borderStyle": "white",
        ...
        "list": [
          ...
          {
            "pagePath": "pages/subscribe/addSubscribe",
            "text": "预约",
            "iconPath": "/images/default3.png",
            "selectedIconPath": "/images/default3.png"
          },
          {
            "pagePath": "pages/usercenter/usercenter",
            "text": "个人中心",
            "iconPath": "/images/default4.png",
            "selectedIconPath": "/images/t4.png"
          }
        ]
      },
  }
...
module.exports = {
  getExtJsons: getExtJsons,
  extjsonTem: extjsonTem,
  request: request,
